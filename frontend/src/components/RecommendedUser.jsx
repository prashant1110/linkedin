...
const RecommendedUser = ({ user }) => {
  ...
  const { mutate: sendRequest } = useMutation({
    mutationFn: async (requestedId) => {
      await axiosInstance.post(`/connections/request/${requestedId}`);
    },
    onSuccess: () => {
  ...
  const { mutate: acceptRequest } = useMutation({
    mutationFn: async (requestedId) => {
      await axiosInstance.put(`/connections/accept/${requestedId}`);
    },
    onSuccess: () => {
  ...
  const { mutate: rejectRequest } = useMutation({
    mutationFn: async (requestedId) => {
      await axiosInstance.put(`/connections/reject/${requestedId}`);
    },
    onSuccess: () => {
